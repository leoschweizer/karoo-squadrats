...
### 2. Get your Squadrats token

Squadrats doesn't have a public API, but serves your data as vector map tiles. You need to extract your personal token from a tile URL:
...
6. Click on any of the `.pbf` requests and look at its URL. Note down the token:
   ```
...
2. Enter your **token** on the Settings screen.
